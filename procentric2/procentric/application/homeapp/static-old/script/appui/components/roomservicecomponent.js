    ...
    function (Component, Container, Label, Button, HorizontalList, VerticalList, LabelI18n, ServiceRoomCategories, ServiceRoomProducts,
        ...
        return Component.extend({
            ...
            _generateCategoryButton: function(category) {
                var self = this;
                var button = new Button();
                button.appendChildWidget(new LabelI18n(category.id, category.name));
                button.addEventListener("focus", function(event) {
            ...
            _onBeforeRender: function() {
                ...
                var image = new Image("contactless-room-service-qr", 'static/img/etereo/qrs/etereo-room-service.png');
