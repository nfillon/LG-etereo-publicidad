define(
    "homeapp/appui/components/carouselmenucomponent",
    [
    ...
    function (service, Component, DataSource, Label, Carousel, Binder, ActivateFirstHandler, WrappingStrip,
        ...
        return Component.extend({
            init: function init () {
                var self = this;
                init.base.call(this, 'carouselComponent2');
