        ...
        return Component.extend({
            init: function init () {
                ...
                this.addEventListener("aftershow", function appReady(evt) {
                    ...
                    if (templateResponse.experiences && templateResponse.experiences.length > 0) {
...
//                                        WG._onSelectHotelInfo(self, e);
            ...
            _createQrImage: function() {
                ...
                this._qrLabel = new Labeli18n('qrLabel','qr_home');//Cada vez que enciendas tu televisor debes escanear el código para hacer streaming y disfrutar de todos los servicios del hotel');
            },
