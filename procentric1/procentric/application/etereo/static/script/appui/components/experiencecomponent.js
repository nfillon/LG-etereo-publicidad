  ...
  function(Component, Container, Image, Label, HorizontalList, VerticalList, Button, I18n) {
    ...
    return Component.extend({
      ...
      _onBeforeRender: function(ev) {
        ...
        this._thankYouMessageRow2Container.appendChildWidget(new Label("thankYouLabel2", "Por compartir con nosotros"));
        this._thankYouMessageRow3Container.appendChildWidget(new Label("thankYouLabel3", "su experiencia Etéreo"));
