define(
    ...
    function (Component, DataSource, Label, Carousel, Binder, ActivateFirstHandler, WrappingStrip,
        ...
        return Component.extend({
            init: function init() {
                var self = this;
                init.base.call(this, 'schedulerComponent');
                ...
                this.addEventListener("beforeshow", function(ev) {
                    if(roomService.orderCompleted){
                        roomService.orderCompleted = false;
                        self.parentWidget.back();
                        self.home.home.parentWidget.back();
                        self.home.home.home._sliderContainer.focus();
                    } else if(restaurant.orderCompleted){
                        restaurant.orderCompleted = false;
                        self.parentWidget.back();
                        self.parentWidget.back();
                        self.home.home._sliderContainer.focus();
                    } else {
                ...
                this.addEventListener('keydown', function(e){
                    if (e.keyCode == 461) {
                        ...
                        //para volver de la tv a la app
                        service.onKeyDown(e.keyCode);
                        self.home._hcapStart();
                    }
                })
            },
