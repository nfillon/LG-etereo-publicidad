    ...
    function(Label, Labeli18n, Container, I18n) {
        ...
        return {
            ...
            _createWelcomeLabelWithStyle: function() {
                ...
                var greetingLabel = new Labeli18n('greetingLabel', 'welcome');
                greetingContainer.appendChildWidget(greetingLabel);
                if( templateResponse.reservation.lastName ){
                    var welcomeText = ' ' + templateResponse.reservation.lastName + ' ';
                ...
                component.appendChildWidget(new Labeli18n("guestRoomLabel", 'welcometext'));
                return component;
            },
